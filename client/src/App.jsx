    ...
    <div className="landing-container">
      ...
      <section className="features">
        <div className="feature-card">
          <div className="icon">📄</div>
          <h3>OCR Digitization</h3>
          <p>Instantly convert handwritten field surveys into digital records.</p>
        </div>
        <div className="feature-card">
          <div className="icon">🤝</div>
          <h3>NGO Coordination</h3>
          <p>Centralized dashboard to verify and act on field data.</p>
        </div>
        <div className="feature-card">
          <div className="icon">📍</div>
          <h3>Local Support</h3>
          <p>Individuals can find resources near them instantly.</p>
        </div>
      </section>
    </div>
  );
              ...
              <div className="auth-card">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="input-group">
                    ...
                    <input 
                      type="password" placeholder="••••••••" className="form-input" required
